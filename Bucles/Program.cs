...
while (repeat == true)
{
    ...
    if (nombre.Contains("1") || nombre.Contains("2") || nombre.Contains("3") || nombre.Contains("4") || nombre.Contains("5") || nombre.Contains("6") || nombre.Contains("7") || nombre.Contains("8") || nombre.Contains("9") || nombre.Contains("0"))
    {
